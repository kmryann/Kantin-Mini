...
// Ganti Geist ke Inter dan JetBrains_Mono
const inter = Inter({
  subsets: ["latin"],
  variable: "--font-sans",
  display: "swap",
...
export const metadata: Metadata = {
  ...
  generator: "v0.app",
  keywords: "kantin mini, makanan indonesia, paket nasi, pempek, chicken bites, makanan murah, delivery makanan",
  authors: [{ name: "Kantin Mini" }],
  openGraph: {
    title: "Kantin Mini - Cita Rasa Nusantara",
    description: "Nikmati kelezatan masakan Indonesia dengan bahan segar, harga terjangkau, dan pelayanan cepat.",
    type: "website",
    locale: "id_ID",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kantin Mini - Cita Rasa Nusantara",
      },
    ],
